...
namespace culling
{
	namespace DepthValueComputer
	{
		...
		FORCE_INLINE extern void ComputeFlatBottomDepthValue
		(
		...
		)
		{
			...
			assert(_mm256_test_all_ones(*reinterpret_cast<const culling::M256I*>(&LE_12Y)));
			assert(_mm256_test_all_ones(*reinterpret_cast<const culling::M256I*>(&LE_13Y)));
#endif
		...
		FORCE_INLINE extern void ComputeFlatTopDepthValue
		(
			const size_t triangleCount,
			const eDepthType targetDepthType,
			culling::M256F* const subTileMaxValues,
