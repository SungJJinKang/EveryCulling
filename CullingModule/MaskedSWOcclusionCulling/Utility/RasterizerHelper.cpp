#include "RasterizerHelper.h"


extern void culling::rasterizerHelper::GetMiddlePointOfTriangle
(
...
)
{
	...
	const culling::M256F point4Z
		= culling::M256F_ADD(TriPointA_X, culling::M256F_MUL(culling::M256F_DIV(culling::M256F_SUB(TriPointB_Z, TriPointA_Z), culling::M256F_SUB(TriPointC_Z, TriPointA_Z)), culling::M256F_SUB(TriPointC_X, TriPointA_X)));
