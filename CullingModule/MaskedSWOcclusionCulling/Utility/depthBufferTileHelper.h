...
namespace culling
{
	namespace depthBufferTileHelper
	{
		...
		)
		{
			...
			minScreenPixelX = _mm256_max_epi32(minScreenPixelX, _mm256_set1_epi32(0));
			minScreenPixelY = _mm256_max_epi32(minScreenPixelY, _mm256_set1_epi32(0));
			maxScreenPixelX = _mm256_max_epi32(maxScreenPixelX, _mm256_set1_epi32(0));
			maxScreenPixelY = _mm256_max_epi32(maxScreenPixelY, _mm256_set1_epi32(0));
			// How "and" works?
