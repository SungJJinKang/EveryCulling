...
namespace culling
{
	namespace depthBufferTileHelper
	{
		...
		(
			...
			culling::M256I& outBinBoundingBoxMaxX,
			culling::M256I& outBinBoundingBoxMaxY,
			const culling::M256F& nagativeWMask,
			SWDepthBuffer& depthBuffer
		)
		{
			culling::M256I minScreenPixelX, minScreenPixelY, maxScreenPixelX, maxScreenPixelY;
			...
			minScreenPixelX = _mm256_cvttps_epi32(_mm256_floor_ps(_mm256_min_ps(_mm256_blendv_ps(pointAScreenPixelX, _mm256_set1_ps(depthBuffer.mResolution.mWidth), nagativeWMask), _mm256_min_ps(_mm256_blendv_ps(pointBScreenPixelX, _mm256_set1_ps(depthBuffer.mResolution.mWidth), nagativeWMask), _mm256_blendv_ps(pointCScreenPixelX, _mm256_set1_ps(depthBuffer.mResolution.mWidth), nagativeWMask)))));
			minScreenPixelY = _mm256_cvttps_epi32(_mm256_floor_ps(_mm256_min_ps(_mm256_blendv_ps(pointAScreenPixelY, _mm256_set1_ps(depthBuffer.mResolution.mHeight), nagativeWMask), _mm256_min_ps(_mm256_blendv_ps(pointBScreenPixelY, _mm256_set1_ps(depthBuffer.mResolution.mHeight), nagativeWMask), _mm256_blendv_ps(pointCScreenPixelY, _mm256_set1_ps(depthBuffer.mResolution.mHeight), nagativeWMask)))));

			maxScreenPixelX = _mm256_cvttps_epi32(_mm256_ceil_ps(_mm256_max_ps(_mm256_blendv_ps(pointAScreenPixelX, _mm256_set1_ps(0.0f), nagativeWMask), _mm256_max_ps(_mm256_blendv_ps(pointBScreenPixelX, _mm256_set1_ps(0.0f), nagativeWMask), _mm256_blendv_ps(pointCScreenPixelX, _mm256_set1_ps(0.0f), nagativeWMask)))));
			maxScreenPixelY = _mm256_cvttps_epi32(_mm256_ceil_ps(_mm256_max_ps(_mm256_blendv_ps(pointAScreenPixelY, _mm256_set1_ps(0.0f), nagativeWMask), _mm256_max_ps(_mm256_blendv_ps(pointBScreenPixelY, _mm256_set1_ps(0.0f), nagativeWMask), _mm256_blendv_ps(pointCScreenPixelY, _mm256_set1_ps(0.0f), nagativeWMask)))));
